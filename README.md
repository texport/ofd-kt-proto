...
[![Version](https://img.shields.io/badge/version-2.0.3--1-blue.svg)](https://github.com/texport/ofd-kt-proto/releases)
...
kotlin {
    sourceSets {
        commonMain {
            dependencies {
                implementation("io.github.texport:ofd-kt-proto:2.0.3-1")
            }
        }
    }
}
